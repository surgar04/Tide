...
const PunishmentNode = ({ data, selected }: NodeProps) => {
    ...
    >
      ...
      <div className="flex items-center gap-3">
         ...
         <div className="flex flex-col">
            <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">PENALTY</span>
            <div className="font-bold text-slate-700 text-xs">
                <span className="text-red-600 mr-1">-{nodeData.amount || '10'}</span>
                <span>{nodeData.punishmentType || 'HP'}</span>
            </div>
         </div>
      </div>
...
export default memo(PunishmentNode);
